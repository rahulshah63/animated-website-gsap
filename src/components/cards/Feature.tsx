...
export const FeatureCard: FC<FeatureCardProps> = ({ title, tag, description, image, className }) => {
   return (
      <div
        className={cn(
          'feature-card relative flex flex-col md:flex-row justify-center items-center gap-5 rounded-[2.125rem] px-[1.1875rem] w-[90%] md:w-[80%] max-w-[1275px]',
          className,
        )}
        // onClick={handleClick}
      >
