...
export const StepCard: FC<StepCardProps> = ({ title, tag, description, className }) => {
   return (
      <div
        className={cn(
          'step-card relative shadow-[0_35px_60px_-15px_rgba(224,185,255,1)] flex md:flex-col gap-8 px-[1.1875rem] md:px-[2rem] py-6 md:py-8 rounded-[1.25rem] md:rounded-[2.8125rem] max-w-[382px]',
          className,
        )}
      >
      <img src={StepBG} alt="step-card-image"  className="absolute -left-7 -top-7 md:scale-150 md:-left-2 md:-top-1  pointer-events-none"/>
        ...
        <div className='flex flex-col items-baseline justify-normal gap-5'>
